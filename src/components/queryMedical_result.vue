<template>
  <div>
    <!--头部-->
    <nav-header >
       <span slot="headTitle">病案质控查询</span>
    </nav-header>
        ...
        <v-loadmore :bottom-method="loadBottom" :bottom-all-loaded="allLoaded" :auto-fill="false" ref="loadmore">
            <div class="wrapper">
                ...
                <li v-for="item in list">
                            ...
                            <a @click='setQuery(item.firstGuid,item.patient_name,item.mr_id,item.id_number)'>
                                ...
                                <span class="icon_star icon_query"  @click.prevent='collectedToggle($event,item.guid)'></span>
                           </a>
                           <!-- </router-link>-->
                    </li>
                </ul>
  ...
  mounted:function(){
   ...
   methods:{
    ...
    loadPageList:function (){
       var url=this.api+'/quality/ajaxGetMedQualityPage';
    ...
    //质控病案
    setQuery(guid,name,mr_id,idCard){
     this.$router.push({
